...
describe("system-inject kiro", () => {
  it("appends to first history user and never writes systemPrompt", () => {
  ...
  it("leaves an existing systemPrompt untouched while injecting the turn", () => {
    const body = {
      systemPrompt: "OLD",
      conversationState: {
  ...
  it("empty user content becomes the prompt", () => {
    const body = {
      conversationState: {
  ...
  it("fails open for a frozen user message", () => {
    const body = {
      conversationState: {
...
describe("system-inject regression fixes", () => {
  it("kiro injection converges on retry after transient content write failure", () => {
  ...
  it("kiro substring occurrence does not suppress injection", () => {
    const body = {
      conversationState: {
